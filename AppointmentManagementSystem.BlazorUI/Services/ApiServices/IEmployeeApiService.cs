...
namespace AppointmentManagementSystem.BlazorUI.Services.ApiServices
{
    public interface IEmployeeApiService
    {
        ...
        Task<ApiResponse<AvailableEmployeesResponse>> GetAvailableEmployeesAsync(int businessId, DateTime selectedDate, TimeSpan selectedTime, int totalDurationMinutes);
